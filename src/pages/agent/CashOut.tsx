...
import { useSearchUserMutation, useCashOutMutation } from "@/redux/feature/userApi";
...
function cashOut() {
  ...
  return (
    <div className="flex flex-col items-center w-full md:p-6 justify-center">
      <h1 className="text-4xl md:text-5xl font-bold text-primary whitespace-nowrap mb-6">Cash Out</h1>
